                    ...
                    @csrf
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control selectpicker" data-live-search="true" name="obatalkes_nama" id="inputData">
                                        @foreach ($obat as $o)
                                       @if ($o->stok > 0)
                <option value="{{ $o->obatalkes_nama }}">{{ $o->obatalkes_nama }} - stok tersedia: {{ $o->stok }}</option>
            @else
                <option value="{{ $o->obatalkes_nama }}" disabled>{{ $o->obatalkes_nama }} - stok habis</option>
            @endif
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control selectpicker" data-live-search="true" name="signa_nama" id="inputData">
                                        @foreach ($signa as $s)
        ...
        @csrf
                <div class="modal-body">
                    <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Racikan Nama" name="racikan_nama">
                            </div>
            ...
            @endif
                    ...
                    <button type="button" class="btn btn-success form-group mb-3" id="addRacikanItem">Tambah Obat</button>
                    <div class="form-group mb-3">
                                    <label for="">Nama Signa</label>
                                    <select class="form-control selectpicker" data-live-search="true" name="signa_nama" id="inputData">
                                        @foreach ($signa as $s)
                ...
                @foreach($resep as $r)
                    @if ($r->racikan_nama === 'empty')
                        <tr>
                            ...
                            <td>{{ $r->qty }}</td>
                            <td>
                                <a href="{{ route('print.row', $r->resep_id) }}">
                                    <button type="button" class="btn btn-info">Cetak Ini</button>
                                </a>
                            </td>
                        </tr>
                    @endif
