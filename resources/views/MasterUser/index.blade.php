  ...
  <body>
    ...
    @include('Layout.nav')
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <tbody>
            <h2>Master User</h2><button type="button" class="btn btn-primary btn-md" data-bs-toggle="modal" data-bs-target="#modalId">
                Tambah Data User
            </button>
...
<td>
     ...
     <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editModal{{$u->id}}">Ubah Password</button> <div class="modal fade" id="editModal{{$u->id}}" tabindex="-1" aria-labelledby="editModal{{$u->id}}Label" aria-hidden="true">
    ...
    @method('PUT')
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="editUser{{$u->name}}" name="name" value="{{$u->name}}"  readonly hidden>
                        </div>
                        <div class="mb-3">
                  
                            <input type="email" class="form-control" id="editEmail{{$u->email}}" name="email" value="{{$u->email}}"  readonly hidden>
                        </div>
                      
                        <div class="mb-3">
                            <input type="password" class="form-control" name="password" value="{{ $u->password }}" placeholder="password anda" id="inputData">
                    
                          
                        </div>

                        <div class="mb-3">
                          <input type="text" class="form-control" id="editPassword{{$u->role}}" name="role" value="{{$u->role}}" readonly hidden >
                            </div>
 ...
 <script>
        function showPassword(userId) {
            ...
            const showPasswordCheckbox = document.getElementById(`showPassword${userId}`);
